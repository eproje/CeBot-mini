...
(function(ext) {
	...
	//hs_add
	ext.CBM_runTone = function(tone,beat){
		runPackage(34,8,short2array(typeof tone=="number"?tone:tones[tone]),short2array(typeof beat=="number"?beat:beats[beat]));
	};
	
	ext.CBM_runLed = function(ledIndex,red,green,blue){
		runPackage(8,3,2,ledIndex=="all"?0:ledIndex,red,green,blue);
	};
	
	//hs add
	
	
	//orion port3 kanal2 de
	/*
	ext.runLed = function(ledIndex,red,green,blue){
		ext.runLedStrip(3, 2, ledIndex, red,green,blue);
	};
